-- MySQL Dump Script for Creating an ODM 1.1.1 Blank Schema within a MySQL Database Called "ODM"
...
CREATE TABLE "LabMethods" (
  "LabMethodID" serial primary key NOT NULL,
...
CREATE TABLE "Units" (
  "UnitsID" serial primary key NOT NULL,
...
CREATE TABLE "Qualifiers" (
  "QualifierID" serial primary key NOT NULL,
...
CREATE TABLE "QualityControlLevels" (
  "QualityControlLevelID" serial primary key not null,
...
CREATE TABLE "Samples" (
  "SampleID" serial primary key NOT NULL,
  "SampleType" VARCHAR(255) NOT NULL DEFAULT 'Unknown' REFERENCES "SampleTypeCV" ("Term"),
  "LabSampleCode" VARCHAR(50) NOT NULL,
  "LabMethodID" INT NOT NULL DEFAULT 0 REFERENCES "LabMethods" ("LabMethodID")
) ;
...
CREATE TABLE "ISOMetadata" (
  "MetadataID" serial primary key NOT NULL,
...
CREATE TABLE "SeriesCatalog" (
  ...
  "TimeSupport" real NULL DEFAULT NULL,
  ...
  "BeginDateTimeUTC" timestamp NULL DEFAULT NULL,
  "EndDateTimeUTC" timestamp NULL DEFAULT NULL,
...
CREATE TABLE "Sources" (
  "SourceID" serial primary key NOT NULL,
  ...
  "MetadataID" INT NOT NULL DEFAULT 0 REFERENCES "ISOMetadata" ("MetadataID")
) ;
...
CREATE TABLE "OffsetTypes" (
  "OffsetTypeID" serial primary key NOT NULL,
  "OffsetUnitsID" INT NOT NULL REFERENCES "Units" ("UnitsID"),
...
CREATE TABLE "Variables" (
  ...
  "VariableCode" VARCHAR(50) unique NOT NULL,
  ...
  "VariableUnitsID" INT NOT NULL REFERENCES "Units" ("UnitsID"),
  ...
  "IsRegular" BOOL NOT NULL DEFAULT false,
  "TimeSupport" real NOT NULL DEFAULT 0,
  "TimeUnitsID" INT NOT NULL DEFAULT 0 REFERENCES "Units" ("UnitsID"),
  ...
  "NoDataValue" real NOT NULL DEFAULT 0
) ;
...
CREATE TABLE "Sites" (
  ...
  "LatLongDatumID" INT NOT NULL DEFAULT 0 REFERENCES "SpatialReferences" ("SpatialReferenceID"),
  "SiteType" VARCHAR(255) NULL DEFAULT NULL REFERENCES "SiteTypeCV" ("Term"),
  "Elevation_m" real NULL DEFAULT NULL,
  "VerticalDatum" VARCHAR(255) NULL DEFAULT NULL REFERENCES "VerticalDatumCV" ("Term"),
  "LocalX" real NULL DEFAULT NULL,
  "LocalY" real NULL DEFAULT NULL,
  "LocalProjectionID" INT NULL DEFAULT NULL REFERENCES "SpatialReferences" ("SpatialReferenceID"),
  "PosAccuracy_m" real NULL DEFAULT NULL,
...
CREATE TABLE "DataValues" (
  ...
  UNIQUE ("DataValue","ValueAccuracy","LocalDateTime","UTCOffset","DateTimeUTC","SiteID","VariableID","OffsetValue","OffsetTypeID","CensorCode","QualifierID","MethodID","SourceID","SampleID","DerivedFromID","QualityControlLevelID"),
  FOREIGN KEY ("SiteID") REFERENCES "Sites" ("SiteID") ON DELETE NO ACTION ON UPDATE CASCADE,
  FOREIGN KEY ("SourceID") REFERENCES "Sources" ("SourceID") ON DELETE NO ACTION ON UPDATE NO ACTION,
  FOREIGN KEY ("QualityControlLevelID") REFERENCES "QualityControlLevels" ("QualityControlLevelID") ON DELETE NO ACTION ON UPDATE NO ACTION,
  FOREIGN KEY ("OffsetTypeID") REFERENCES "OffsetTypes" ("OffsetTypeID") ON DELETE NO ACTION ON UPDATE NO ACTION,
  FOREIGN KEY ("CensorCode") REFERENCES "CensorCodeCV" ("Term") ON DELETE NO ACTION ON UPDATE NO ACTION,
  FOREIGN KEY ("VariableID") REFERENCES "Variables" ("VariableID") ON DELETE NO ACTION ON UPDATE NO ACTION,
  FOREIGN KEY ("MethodID") REFERENCES "Methods" ("MethodID") ON DELETE NO ACTION ON UPDATE NO ACTION,
  FOREIGN KEY ("QualifierID") REFERENCES "Qualifiers" ("QualifierID") ON DELETE NO ACTION ON UPDATE NO ACTION,
  FOREIGN KEY ("SampleID") REFERENCES "Samples" ("SampleID") ON DELETE NO ACTION ON UPDATE NO ACTION
) ;
...
CREATE TABLE "DerivedFrom" (
  ...
  FOREIGN KEY ("ValueID") REFERENCES "DataValues" ("ValueID") ON DELETE NO ACTION ON UPDATE NO ACTION
) ;
...
CREATE TABLE "Groups" (
  ...
  "ValueID" INT NOT NULL,
  FOREIGN KEY ("GroupID") REFERENCES "GroupDescriptions" ("GroupID") ON DELETE NO ACTION ON UPDATE NO ACTION,
  FOREIGN KEY ("ValueID") REFERENCES "DataValues" ("ValueID") ON DELETE NO ACTION ON UPDATE NO ACTION
) ;
