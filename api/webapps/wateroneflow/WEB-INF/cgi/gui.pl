...
sub gui {
	...
	<span id=\"Span1\">
			<p class=\"intro\">Se admiten los siguientes métodos. Para una descripción formal visite <a href=\"http://water.sdsc.edu/waterOneFlow/NWIS/DailyValues.asmx?WSDL\">Service Description</a>.</p>
					...
					<li>
						<a href=\"gui?op=GetSiteInfo\">GetSiteInfo</a>
					...
					<li>
						<a href=\"gui?op=GetSites\">GetSites</a>
					...
					<li>
						<a href=\"gui?op=GetSitesByBoxObject\">GetSitesByBoxObject</a>
						<span id=\"MethodList_ctl03_Span2\">
					...
					<li>
						<a href=\"gui?op=GetValues\">GetValues</a>
					...
					<li>
						<a href=\"gui?op=GetVariables\">GetVariables</a>
	...
	<span id=\"Span1\">
			...
			$form
			<p>URL de descarga: <a id=service_url target=_blank href=\"http://$host/wateroneflow/ws/$_[0]?\">http://$host/wateroneflow/ws/$_[0]?</href></p>
			<script language=\"javascript\">
				var update_url = function () {
					var inputs = document.forms.setargs.getElementsByTagName(\"input\");
					var new_url = 'http://$host/wateroneflow/ws/$_[0]?';
					var count = 0;
